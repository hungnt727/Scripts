...
SONICR_TELEGRAM_CHAT_ID = '-4036836554'
# --- COIN SELECTION ---
...
# SONIC R SCANNER CONFIGURATION
# ============================================

# Số cây nến tối đa tính từ lúc đảo chiều Sonic R
SONICR_SIGNAL_WINDOW = 1

# Cấu hình timeframe để quét Sonic R
SONICR_TIMEFRAME_CONFIGS = [
    #{'timeframe': '1m', 'htf': '15m'},
    {'timeframe': '5m', 'htf': '1h'},
    {'timeframe': '1h', 'htf': '1d'},
    {'timeframe': '4h', 'htf': '1w'},
    {'timeframe': '1d', 'htf': None},
    #{'timeframe': '1w', 'htf': None},
]

# Cấu hình các Setup cho Sonic R
